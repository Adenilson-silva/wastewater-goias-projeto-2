...
| **Por quê? (_Why?_):** Por que esse problema é importante?   | Considerando que o estado não possui recursos suficiente para ser destinado a todos os municipios, é necessário estabelecer critérios objetivos de prioridade.            |
